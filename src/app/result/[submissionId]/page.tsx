...
export default async function ResultPage({ params }: { params: Promise<{ submissionId: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-950 dark:to-teal-900 flex flex-col items-center justify-center p-6 md:p-12 overflow-hidden">
