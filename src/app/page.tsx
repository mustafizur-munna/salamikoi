...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br py-12 from-emerald-50 to-teal-100 dark:from-emerald-950 dark:to-teal-900 flex flex-col items-center p-4 sm:p-6 md:p-12 overflow-y-auto">
