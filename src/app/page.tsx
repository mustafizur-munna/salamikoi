...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-6 md:p-12 bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-950 dark:to-teal-900">
      <div className="max-w-2xl w-full text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-emerald-900 dark:text-emerald-50">
          ঈদ সালামি <span className="text-emerald-600">অ্যাপ</span>
        </h1>
        
        <p className="text-lg sm:text-xl text-emerald-700 dark:text-emerald-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 md:mt-12">
          <Link 
            href="/create"
            className="group relative flex flex-col items-center p-6 sm:p-8 bg-white dark:bg-emerald-900 rounded-2xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 border border-emerald-100 dark:border-emerald-800"
          >
          ...
          <div className="group relative flex flex-col items-center p-6 sm:p-8 bg-white/50 dark:bg-emerald-900/50 rounded-2xl shadow-xl border border-emerald-100 dark:border-emerald-800 backdrop-blur-sm">
        ...
        <div className="pt-8 md:pt-12 text-emerald-600/60 dark:text-emerald-400/40 text-sm font-medium">
