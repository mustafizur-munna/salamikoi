...
export default async function GetSalamiPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-950 dark:to-teal-900 flex flex-col items-center justify-center p-4 sm:p-6 md:p-12">
      ...
      {pool.remainingBudget <= 0 ? (
        <div className="bg-white dark:bg-emerald-900 p-6 sm:p-8 rounded-3xl shadow-xl border border-emerald-100 dark:border-emerald-800 text-center space-y-4">
